            ...
            <div class="col-md-5">
                ...
                <div class="card mt-4">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="my-3 d-flex justify-content-between line-box">
                            <div></div>
                            <div class="line"></div>
                            <div></div>
                        </div>
                        <div>
                            ...
                            <div class="mb-2 text-center">
                                check your <strong>spam</strong> folder, or <a href="">resend the code</a> 
                            </div>
                        </div>
                        <div class="text-center mt-2">
                            <a href="<?= URL ?>/admin/forgot-pass.php"><small>change the email address</small>.</a>
                        </div>
                    </form>
                </div>
            </div>
